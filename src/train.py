...
def train_one_epoch(train_dataloader, model, optimizer, loss):
    ...
    for batch_idx, (data, target) in tqdm(
        ...
        # 2. forward pass: compute predicted outputs by passing inputs to the model # YOUR CODE HERE
        output  = model(data)
        
        # 3. calculate the loss # YOUR CODE HERE
...
def valid_one_epoch(valid_dataloader, model, loss):
    ...
    with torch.no_grad():
        ...
        for batch_idx, (data, target) in tqdm(
            ...
            # 1. forward pass: compute predicted outputs by passing inputs to the model # YOUR CODE HERE
            output  = model(data)
